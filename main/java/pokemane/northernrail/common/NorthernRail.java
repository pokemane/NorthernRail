...
public class NorthernRail {
    ...
    public static final String GUI_DIRECTORY = TEXTURE_NAME_PREFIX + "gui/";
    public static final String BLOCK_TEXTURE_DIRECTORY = TEXTURE_DIRECTORY + "blocks/";
	public static final String RAIL_TEXTURE_DIRECTORY = TEXTURE_DIRECTORY + "rails/";
    ...
    public static int renderIdRail;
